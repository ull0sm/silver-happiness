        ...
        <section className="px-margin-mobile md:px-margin-desktop pt-24 pb-32 min-h-screen flex items-center">
          <div className="max-w-[1440px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
            ...
            <div className="col-span-1 md:col-span-5 relative mt-16 md:mt-0">
              ...
              <div className="relative z-10 border-2 border-black bg-surface-container-lowest h-[500px] w-full overflow-hidden">
                <div
                ...
                >
                  {/* Brutalist placeholder grid */}
                  <div className="w-full h-full flex flex-col gap-4 p-8 opacity-60">
